...
Each project pairs with a concept write-up in [`docs/`](docs) aimed at engineers entering the field, with a "going deeper" layer for the experienced. These also feed my Medium articles (link coming soon).
